...
function ListItem({ children = react_1.default.createElement(AutoField_1.default, { className: "col-xs-11", label: null, name: "" }), removeIcon, }) {
    return (react_1.default.createElement("div", { className: "row" },
        react_1.default.createElement("div", { className: "col-xs-1" },
