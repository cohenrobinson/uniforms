...
function Radio(_a) {
    var { options, disabled, id, label, name, onChange, readOnly, value } = _a, props = (0, tslib_1.__rest)(_a, ["options", "disabled", "id", "label", "name", "onChange", "readOnly", "value"]);
    return (react_1.default.createElement("div", Object.assign({}, (0, omit_1.default)((0, uniforms_1.filterDOMProps)(props), ['checkboxes'])),
        label && react_1.default.createElement("label", null, label), options === null || options === void 0 ? void 0 :
        options.map(option => {
            var _a, _b, _c, _d;
