...
function Radio(props) {
    ...
    return (0, wrapField_1.default)(props, (_a = props.options) === null || _a === void 0 ? void 0 : _a.map(item => {
        var _a, _b, _c, _d;
        return (react_1.default.createElement("div", { key: (_a = item.key) !== null && _a !== void 0 ? _a : item.value, className: (0, classnames_1.default)(props.inputClassName, 'form-check', {
