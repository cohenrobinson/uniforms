...
function ListAdd(_a) {
    ...
    return (react_1.default.createElement("div", Object.assign({}, (0, uniforms_1.filterDOMProps)(props), { className: (0, classnames_1.default)('badge badge-pill float-right', className), onClick: onAction, onKeyDown: onAction, role: "button", tabIndex: 0 }), addIcon));
}
