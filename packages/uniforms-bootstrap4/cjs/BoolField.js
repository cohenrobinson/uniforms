...
function Bool(_a) {
    ...
    return (0, wrapField_1.default)(Object.assign(Object.assign({}, props), { label: labelBefore, value: props.value }), react_1.default.createElement("div", { className: (0, classnames_1.default)(inputClassName, 'form-check', 'checkbox', {
