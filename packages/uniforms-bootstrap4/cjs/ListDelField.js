...
function ListDel(_a) {
    ...
    return (react_1.default.createElement("span", Object.assign({}, (0, uniforms_1.filterDOMProps)(props), { className: (0, classnames_1.default)('badge badge-pill', className), onClick: onAction, onKeyDown: onAction, role: "button", tabIndex: 0 }), removeIcon));
}
