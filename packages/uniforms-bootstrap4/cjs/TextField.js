...
function Text(props) {
    var _a, _b;
    return (0, wrapField_1.default)((0, omit_1.default)(props, ['autoComplete']), react_1.default.createElement("input", { autoComplete: props.autoComplete, className: (0, classnames_1.default)(props.inputClassName, 'form-control', {
